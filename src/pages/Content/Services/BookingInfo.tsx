...
export function BookingInfoPage() {
  return (
    <div className="min-h-screen p-4 sm:p-6 md:p-8 bg-slate-50 overflow-hidden
     bg-[url('https://benhviengreen.com/wp-content/uploads/2016/05/doctor-health-wellness-1200x480.jpg')] bg-cover bg-center bg-no-repeat">
      ...
      <Tabs defaultValue="consultant" className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl p-8 bg-white shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl">
                ...
                <ul className="space-y-4">
                    <li className="flex gap-3"><Lock className="text-green-500 shrink-0 mt-1 w-5 h-5"/><div><h4 className="font-semibold">Absolute Confidentiality</h4><p className="text-sm text-gray-500">Your privacy is our highest priority.</p></div></li>
                    <li className="flex gap-3"><Heart className="text-green-500 shrink-0 mt-1 w-5 h-5"/><div><h4 className="font-semibold">Empathetic Approach</h4><p className="text-sm text-gray-500">You will be treated with respect and kindness.</p></div></li>
                    <li className="flex gap-3"><UserCheck className="text-green-500 shrink-0 mt-1 w-5 h-5"/><div><h4 className="font-semibold">Qualified Experts</h4><p className="text-sm text-gray-500">Receive advice from certified professionals.</p></div></li>
                </ul>
            </div>
            ...
            <div className="rounded-2xl p-8 bg-white shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl">
                ...
                <ol className="relative space-y-6">
                    <li><h4 className="font-semibold mb-1">1. Book Securely</h4><p className="text-sm text-gray-500">Choose a time that fits your schedule through our confidential online portal.</p></li>
                    <li><h4 className="font-semibold mb-1">2. Connect & Share</h4><p className="text-sm text-gray-500">Engage in a one-on-one video or phone call with your dedicated specialist.</p></li>
                    <li><h4 className="font-semibold mb-1">3. Receive Your Plan</h4><p className="text-sm text-gray-500">Get a personalized summary and clear next steps sent directly to you.</p></li>
                </ol>
            </div>
            ...
            <div className="lg:col-span-2 relative rounded-2xl p-8 bg-gradient-to-br from-[#1A3973] to-[#122850] text-white shadow-xl shadow-blue-900/20 transition-all duration-300 hover:shadow-2xl flex flex-col items-center text-center justify-center">
                 ...
                 <div className="relative z-10 flex flex-col items-center">
                    ...
                    {/* THAY ĐỔI: Áp dụng style mới cho nút Book Consultant */}
        ...
        <TabsContent value="service" className="mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 rounded-2xl p-8 bg-white shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl">
                    <div className="flex items-center gap-3 mb-6 text-[#1A3973]"><Sparkles className="w-7 h-7" /><h2 className="text-3xl font-bold">Our Service Categories</h2></div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        {serviceCategories.map(s => (
                            <div key={s.name} className="flex flex-col p-5 rounded-lg bg-slate-100/70 hover:bg-white hover:shadow-sm transition-all">
                                <div className="flex items-center gap-3 mb-2"><div className="bg-blue-200 text-blue-800 p-2 rounded-lg"><s.icon className="w-5 h-5" /></div><h4 className="font-semibold text-gray-800">{s.name}</h4></div>
                ...
                <div className="rounded-2xl p-8 bg-white shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl flex flex-col">
                    <div className="flex-grow">
                        <div className="flex items-center gap-3 mb-4 text-[#1A3973]"><HelpCircle className="w-6 h-6" /><h3 className="text-xl font-bold">Quick FAQ</h3></div>
                        <div className="space-y-4 text-sm">
                            ...
                            <div><h4 className="font-semibold text-gray-800">Do I need a doctor's referral?</h4><p className="text-gray-500">No, a referral is not required to book a service with us.</p></div>
                        </div>
                    </div>
