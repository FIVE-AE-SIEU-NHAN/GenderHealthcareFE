...
export function BookingInfoPage() {
  return (
    <div className='min-h-screen overflow-hidden bg-slate-50 p-4 sm:p-6 md:p-8'>
      ...
      <Tabs defaultValue='consultant' className='mx-auto max-w-7xl'>
        ...
        <TabsContent value='consultant' className='mt-8'>
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
            {/* CARD GIỚI THIỆU LỚN */}
            <div className='rounded-2xl border border-gray-100 bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl lg:col-span-2'>
              ...
              <p className='text-lg text-gray-600'>
                Our consultations are more than just appointments; they are dedicated moments for you to be heard. In a
                safe, non-judgmental space, our specialists will listen to your concerns, answer your questions, and
            ...
            {/* CARD CTA LỚN */}
            <div className='relative flex flex-col items-center justify-center rounded-2xl bg-gradient-to-br from-[#1A3973] to-[#122850] p-8 text-center text-white shadow-xl shadow-blue-900/20 transition-all duration-300 hover:shadow-2xl lg:col-span-2'>
              <SubtleGridPattern />
              <div className='relative z-10'>
                ...
                <Link
                  to='/book-consultant'
                  className='inline-flex items-center justify-center gap-3 rounded-full bg-white px-8 py-4 text-lg font-bold text-[#1A3973] uppercase transition-colors hover:bg-gray-200'
                >
                  <PhoneCall size={20} />
                  Book a Consultation
                </Link>
        ...
        <TabsContent value='service' className='mt-8'>
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
            ...
            <div className='flex flex-col items-center justify-between gap-6 rounded-2xl bg-gradient-to-r from-[#1A3973] to-[#4F80E1] p-8 text-white shadow-xl shadow-blue-500/30 md:flex-row lg:col-span-3'>
              ...
              <div className='flex w-full flex-shrink-0 flex-col items-center gap-4 sm:w-auto sm:flex-row'>
                <Link
                  to='/book-service'
                  className='flex w-full items-center justify-center gap-3 rounded-full bg-white px-6 py-3 font-bold text-[#1A3973] uppercase transition-colors hover:bg-gray-200 sm:w-auto'
                >
                ...
                <Link
                  to='/services'
                  className='flex w-full items-center justify-center gap-3 rounded-full border-2 border-white/60 bg-transparent px-6 py-3 text-sm font-bold uppercase transition-colors hover:bg-white/10 sm:w-auto'
                >
                ...
                <Link
                  to='/cycles'
                  className='flex w-full items-center justify-center gap-3 rounded-full bg-white/10 px-6 py-3 text-sm font-bold text-white uppercase transition-colors hover:bg-white/20 sm:w-auto'
                >
