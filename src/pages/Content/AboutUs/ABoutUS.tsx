...
const AboutUsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8e97a5] to-[#2c5282]">
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        {/* Our Story Section */}
        <Card className="mb-8 p-5 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <CardHeader>
            <CardTitle className="text-3xl md:text-4xl font-bold text-slate-800 relative">
              <div className='pb-3'>Our Story</div>
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#1A3973] to-[#2c5282] rounded-full"></div>
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-8 p-5 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <CardHeader>
            <CardTitle className="text-3xl md:text-4xl font-bold text-slate-800 relative">
              <div className='pb-3'>Our Values</div>
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#1A3973] to-[#2c5282] rounded-full"></div>
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* Statistics Section */}
        <div className="bg-gradient-to-r from-[#1A3973]/70 to-[#2c5282] text-white text-center p-12 md:p-16 rounded-3xl mb-8
        ...
        <Card className="mb-8 p-5 shadow-xl ">
          <CardHeader>
            <CardTitle className="text-3xl md:text-4xl font-bold text-slate-800 relative">
              <div className='pb-3'>Our Services</div>
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#1A3973] to-[#2c5282] rounded-full"></div>
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-8 p-5 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
          <CardHeader>
            <CardTitle className="text-3xl md:text-4xl font-bold text-slate-800 relative">
              <div className='pb-3'>Our Commitment</div>
              <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#1A3973] to-[#2c5282] rounded-full"></div>
            </CardTitle>
          </CardHeader>
          <CardContent>
