    ...
    <>
      ...
      <div className='relative w-full'>
        ...
        <svg
          ...
          className='absolute -bottom-14 left-0 z-1 w-full'
        >
          <path
            fill='#e4e8ff'
      ...
      <div className='relative w-full bg-gradient-to-b from-[#e4e8ff] to-[#f0f4ff]'>
        <Doctors />
        <svg
          className='absolute left-0 -z-2 w-full sm:-bottom-0 md:-bottom-13 lg:-bottom-18'
          viewBox='0 0 1440 100'
          xmlns='http://www.w3.org/2000/svg'
        >
          <path
      ...
      <div className='relative overflow-hidden'>
        ...
        <div className='absolute top-20 -left-70 -z-10 h-144 w-137 rounded-full bg-blue-300 opacity-12 blur-2xl' />
        <div className='absolute -right-60 -bottom-20 -z-10 h-140 w-120 rounded-full bg-purple-300 opacity-12 blur-2xl' />
        <News />
      </div>
    </>
  )
