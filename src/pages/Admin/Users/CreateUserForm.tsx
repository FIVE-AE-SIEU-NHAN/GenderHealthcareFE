...
import { z } from 'zod'
import { User as UserIcon, SendHorizonal, Briefcase, Loader2 } from 'lucide-react'
...
const formSchema = z
  .object({
    ...
    phone_number: z
      .string()
      .regex(/(84|0[3|5|7|8|9])+([0-9]{8})\b/, { message: 'Please enter a valid Vietnamese phone number.' }),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
        ...
        <Card className='animate-fade-in-up pt-6 pb-6 [animation-delay:50ms] [animation-fill-mode:backwards]'>
          <CardHeader>
            <CardTitle className='text-semi-dark-blue flex items-center gap-2 text-lg text-shadow-md'>
              <UserIcon className='text-semi-dark-blue h-6 w-6' />
              Account Details
            </CardTitle>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className={inputStyles} placeholder='John Doe' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type='email' className={inputStyles} placeholder='user@example.com' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type='password' className={inputStyles} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className={inputStyles} placeholder='09xxxxxxxx' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex'>
                  {' '}
                  {/* Logic preserved: className is untouched */}
        ...
        {IS_CONSULTANT && (
          <Card className='animate-fade-in-up pt-6 pb-6 [animation-fill-mode:backwards]'>
            <CardHeader>
              <CardTitle className='text-semi-dark-blue flex items-center gap-2 text-lg text-shadow-md'>
                <Briefcase className='text-semi-dark-blue h-6 w-6' />
                Consultant Profile
              </CardTitle>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        {TOPIC_OPTIONS.map((o) => (
                          <SelectItem key={o.value} value={o.value} disabled={o.value === selectedSpec1}>
                            {o.label}
                          </SelectItem>
                        ))}
                      </SelectContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input className={inputStyles} placeholder='e.g., PhD in Psychology' {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type='number' min='0' className={inputStyles} placeholder='5' {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        {/* === SUBMIT BUTTON === */}
        <div className='animate-fade-in-up flex justify-end [animation-delay:300ms] [animation-fill-mode:backwards]'>
          <Button
            type='submit'
            size='lg'
            disabled={createUser.isPending}
            className='from-primary bg-gradient-to-br to-blue-700 text-lg font-bold text-white shadow-md transition-all duration-200 hover:scale-101 hover:shadow-lg'
          >
