  ...
  const renderUserActions = useCallback(
    (user: User) => {
      ...
      const isMutatingThisUser =
        editUserStatusMutation.isPending && editUserStatusMutation.variables?.userId === user.id
          ...
          <DialogHeader className='rounded-t-lg border-b bg-gradient-to-br from-slate-50 to-slate-100 p-6 pb-4'>
            <div className='flex items-center gap-4'>
              ...
              <div className='flex flex-col'>
                <DialogTitle className='text-foreground text-3xl font-bold tracking-tight'>Add New User</DialogTitle>
