...
export default function SignupForm() {
  ...
  return (
    <Card className='animate-fade-in-up z-10 mt-8 mb-8 w-full max-w-xl shadow-2xl'>
      <CardHeader className='text-center'>
        <img src={logo} alt='logo' className='mx-auto w-20' />
        <CardTitle className='text-dark-blue text-2xl font-bold text-shadow-lg'>Hello there!</CardTitle>
      ...
      <CardContent className='mb-7'>
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4 text-base [&_input]:h-11 [&_label]:font-semibold'>
          {/* Full Name */}
          ...
          <div className='grid grid-cols-2'>
            <div className='space-y-2'>
              ...
              <Controller control={control} name='date_of_birth' render={({ field }) => <DatePicker field={field} />} />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select onValueChange={field.onChange} value={field.value}>
                    <SelectTrigger className='h-11 min-h-[2.75rem] w-full px-3'>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                ...
                <Input
                  ...
                  disabled={isSubmitting}
                  className={cn('pr-10 pl-8', { 'border-red-500': errors.confirm_password })}
                />
                <button
                  type='button'
                  className='absolute top-3 right-2 text-gray-600'
          ...
          <div className='space-y-2'>
            ...
            <div className='flex gap-2'>
              ...
              <Button
                type='button'
                variant='outline'
                className='h-11 w-[120px] shrink-0 cursor-pointer bg-[#00b3b6] font-semibold text-white shadow-sm transition-all duration-200 ease-in-out hover:bg-[#00b3b6] hover:text-white active:scale-[0.97]'
            ...
            {errors.email_verify_token && <p className='text-sm text-red-500'>{errors.email_verify_token.message}</p>}
          </div>

          {/* Submit */}
          <Button
            type='submit'
            className='bg-dark-blue hover:bg-dark-blue h-[45px] w-full cursor-pointer text-lg shadow-sm transition-all duration-200 ease-in-out active:scale-[0.99] active:bg-[#131045]'
            disabled={isSubmitting}
          >
