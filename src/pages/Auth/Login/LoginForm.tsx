...
export default function LoginForm() {
  ...
  return (
    <Card className='animate-fade-in-up z-10 mt-8 mb-8 w-full max-w-lg shadow-2xl'>
      <CardHeader className='text-center'>
        <img src={logo} alt='logo' className='mx-auto w-20' />
        <CardTitle className='text-dark-blue text-2xl font-bold text-shadow-lg'>Welcome Back</CardTitle>
      ...
      <CardContent className='mb-7'>
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4 text-base [&_input]:h-11 [&_label]:font-semibold'>
          ...
          <div className='relative space-y-2'>
            ...
            <div className='relative'>
              ...
              <Input
                ...
                {...register('password')}
                disabled={isSubmitting}
                className={cn('pr-10 pl-8', { 'border-red-500': errors.password })}
              />
              <button
                type='button'
          ...
          <Button
            type='submit'
            className='bg-dark-blue hover:bg-semi-dark-blue h-[45px] w-full text-lg'
            disabled={isSubmitting}
          >
