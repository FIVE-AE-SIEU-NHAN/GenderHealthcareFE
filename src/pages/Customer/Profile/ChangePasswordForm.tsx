...
function ChangePasswordForm({ onCancel, onSuccess }: ChangePasswordFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 space-y-4 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
...
const GoogleAuthNotice = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-blue-500/20 bg-gradient-to-tr from-blue-100/80 via-white to-blue-50 p-6 shadow-md transition-all duration-300 hover:shadow-md/20">
      <div className="relative z-10 flex flex-col items-center text-center md:flex-row md:text-left md:gap-6">
        ...
        <div className="flex-grow">
          <h4 className="text-lg font-bold text-blue-900 dark:text-blue-200">
            Create a Password for Extra Security
          </h4>
        ...
        <div className="mt-4 flex-shrink-0 md:mt-0">
          <Button 
            ...
            className="group bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-md transition-all duration-300 hover:shadow-lg"
          >
            Set Password
