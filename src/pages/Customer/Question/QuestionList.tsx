...
const allQuestionColumns = [
  {
    ...
    render: (question: Question) => {
      ...
      return (
        <Badge className={cn('text-xs font-medium', topic?.style ?? 'border-muted bg-muted/10 text-muted-foreground')}>
...
export default function QuestionListDashboard() {
  ...
  return (
    <>
      ...
      <ViewAnswerDialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen} question={selectedQuestion} />
    </>
  )
}
