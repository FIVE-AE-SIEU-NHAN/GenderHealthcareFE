...
const VideoChatRoom: React.FC<VideoChatRoomProps> = ({ chat_room_id, onLeave }) => {
  ...
  return (
    <>
      <style>{styles}</style>
      <div className='flex h-[calc(84vh)] flex-col rounded-3xl bg-gray-900 font-sans text-white'>
        ...
        {/* Bottom Control Bar */}
        <div className='bg-opacity-50 flex items-center justify-center gap-6 rounded-b-3xl border-t border-gray-700 bg-gray-900 py-3'>
          <button
