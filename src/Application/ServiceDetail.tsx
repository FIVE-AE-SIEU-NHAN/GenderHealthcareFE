  ...
  return (
    <div className='font-sans text-gray-800'>
      ...
      <div className='max-w-6xl mx-auto mt-10 pb-16 px-4 space-y-6'>
        ...
        <div className='bg-[#F2F3FC] flex flex-col md:flex-row p-5 rounded-lg'>
          <div className='w-full md:w-2/5'>
            <img src="/images/ab1.webp" alt="Emergency care" className='h-full md:pr-5 rounded-lg' />
          </div>
          <div className='w-full md:w-3/5'>
            ...
            <div className="flex items-center gap-4">
              <Link to={"/bookingservices"}>
                <Button className="bg-[#1A3973] hover:bg-[#2A59A3] transition-colors text-white font-semibold rounded-sm">
                  Book An Appointment
                </Button>
              </Link>
