...
import { EditConsultantStatusPayload, EditConsultantStatusResponse, UpdateConsultantProfilePayload, UpdateConsultantProfileResponse } from '@/types/manager/consultantTypes';
