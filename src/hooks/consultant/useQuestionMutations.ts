...
export const useQuestionMutations = () => {
  ...
  const answerQuestionMutation = useMutation<QuestionMutationResponse, Error, AnswerQuestionPayload>({
  ...
  // =============== EDITING AN ANSWER ===============
  const editAnswerMutation = useMutation<QuestionMutationResponse, Error, AnswerQuestionPayload>({
